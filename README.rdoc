...
If you want the matchers for Brasil and you are using shoulda-matchers, add this line to your spec_helper.rb :
    require "validates_telephone/shoulda-matchers/validate_as_br_telephone_matcher"
If you want the matchers for Brasil and you are using remarkable, add this line to your spec_helper.rb :
