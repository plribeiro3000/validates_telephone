...
In case you want it to be a valid telephone for United States, just pass the locale as usa:
...
You should use validates_as_br_telephone(:attribute) for brazil telephones and validates_as_usa_telephone(:attribute) for united states telephones just like any other shoulda or remarkable matcher.
